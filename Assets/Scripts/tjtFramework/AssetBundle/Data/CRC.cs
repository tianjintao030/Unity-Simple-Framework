...
public static class CRC
{
    ...
    internal sealed class CRC32 : HashAlgorithm
    {
        ...
        {
            _hash = CalculateHash(_table, _hash, array, ibStart,
            cbSize);
        }
        ...
        {
            return ~CalculateHash(InitializeTable(polynomial), seed,
        ...
        private static uint CalculateHash(uint[] table, uint seed,
        IList<byte> buffer, int start, int size)
        {
            var hash = seed;
